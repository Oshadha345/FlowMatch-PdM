...
class CWRUDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir: str = "datasets/processed/cwru",
                 window_size: int = 2048, batch_size: int = 256, **kwargs):
        super().__init__()
    ...
    def _resolve_data_dir(self) -> str:
        ...
        raise FileNotFoundError(
            "CWRU processed .npy files not found. Checked paths:"
    ...
    def setup(self, stage=None):
        ...
        print(f"[CWRU] Loaded from {data_dir}/  "
    ...
    def get_minority_dataset(self) -> Subset:
        ...
        print(
            f"[CWRU] Minority label(s): {minority_labels.tolist()} "
